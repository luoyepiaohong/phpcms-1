...
<form action="?m=attachment&c=attachment&a=remote_add" class="form-horizontal" method="post" name="myform" id="myform">
    ...
    <div class="portlet-body form myfooter">
        <div class="form-actions text-center">
            <button name="dosubmit" type="submit" class="button btn green"> <i class="fa fa-save"></i> <?php echo L('保存');?></button>
            <button type="button" onclick="dr_test_attach()" class="button btn red"> <i class="fa fa-cloud"></i> <?php echo L('测试');?></button>
        </div>
    </div>
</form>
</div>
