...
<form action="?m=attachment&c=attachment&a=save" class="form-horizontal" method="post" name="myform" id="myform">
                    ...
                    <div class="tab-pane active" id="div_setting_1">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <label><select class="form-control" name="data[sys_attachment_attach]">
                                        <option value="0"<?php echo ($sys_attachment_attach=='0') ? ' selected' : ''?>>本地存储</option>
                                        <?php foreach ($remote as $i=>$t) {?>
                                        <option value="<?php echo $i;?>"<?php echo ($i == $sys_attachment_attach ? ' selected' : '');?>> <?php echo L($t['name']);?> </option>
                                        <?php }?>
                                    </select></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <span class="help-block">默认存储目录为：/年月/文件名</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group dr_attachment_type"<?php echo ($sys_attachment_save_type=='0') ? ' style="display: none"' : ''?>>
                                ...
                                <div class="col-md-9">
                                    <label><input class="form-control input-xlarge" type="text" name="data[sys_attachment_save_dir]" value="<?php echo $sys_attachment_save_dir;?>" ></label>
                                ...
                                <div class="col-md-9">
                                    <div class="input-group input-xlarge">
                                        ...
                                        <span class="input-group-btn">
                                                <button class="button btn blue" onclick="dr_test_domain_dir('dr_attachment_dir')" type="button"><i class="fa fa-code"></i> 测试</button>
                                            </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group input-xlarge">
                                        ...
                                        <span class="input-group-btn">
                                                <button class="button btn blue" onclick="dr_test_domain()" type="button"><i class="fa fa-wrench"></i> 检测</button>
                                            </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="input-group input-xlarge">
                                        ...
                                        <span class="input-group-btn">
                                                <button class="button btn blue" onclick="dr_test_domain_dir('dr_avatar_dir')" type="button"><i class="fa fa-code"></i> 测试</button>
                                            </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group input-xlarge">
                                        ...
                                        <span class="input-group-btn">
                                                <button class="button btn blue" onclick="dr_test_avatar_domain()" type="button"><i class="fa fa-wrench"></i> 检测</button>
                                            </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="input-group input-xlarge">
                                        ...
                                        <span class="input-group-btn">
                                                <button class="button btn blue" onclick="dr_test_domain_dir('dr_thumb_dir')" type="button"><i class="fa fa-code"></i> 测试</button>
                                            </span>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group input-xlarge">
                                        ...
                                        <span class="input-group-btn">
                                                <button class="button btn blue" onclick="dr_test_thumb_domain()" type="button"><i class="fa fa-wrench"></i> 检测</button>
                                            </span>
                                    </div>
    ...
    <div class="portlet-body form myfooter">
        <div class="form-actions text-center">
            <button name="dosubmit" type="submit" class="button btn green"> <i class="fa fa-save"></i> 保存</button>
        </div>
    </div>
</form>
