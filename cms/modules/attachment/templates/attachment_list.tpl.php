...
<div class="admin-main layui-anim layui-anim-upbit">
    ...
    <div class="demoTable" id="searchid" style="display:<?php if(!isset($_GET['search'])) echo 'none';?>">
        ...
        <?php echo form::date('start_uploadtime',$start_uploadtime,'1','0','true','1')?><?php echo L('to')?><?php echo form::date('end_uploadtime',$end_uploadtime)?>
        <?php echo L('filetype')?>
...
<script type="text/html" id="action">
    <a href="javascript:preview({{d.aid}}, '{{d.filename}}','{{d.filepath}}')" class="layui-btn layui-btn-xs layui-btn-normal"><i class="fa fa-eye"></i> <?php echo L('preview');?></a>
...
layui.use(['table'], function(){
    ...
    var tableIn = table.render({
        id: 'content',
        elem: '#list',
        url:'?m=attachment&c=manage&a=init&module=<?php echo $_GET['module'];?>&status=<?php echo $_GET['status'];?>&pc_hash='+pc_hash,
        method: 'post',
        toolbar: '#topBtn',
        cellMinWidth: 80,
        page: true,
        cols: [[
            ...
            {width: 160, align: 'center', toolbar: '#action',title:'<?php echo L('operations_manage');?>', fixed: 'right'}
        ]],
        limit: 10
    });
    //搜索
