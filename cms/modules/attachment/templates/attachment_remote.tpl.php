...
<div class="admin-main layui-anim layui-anim-upbit">
    ...
    <blockquote class="layui-elem-quote">
        <a href="?m=attachment&c=attachment&a=remote_add&menuid=<?php echo $_GET['menuid'];?>" class="layui-btn layui-btn-sm">
...
<script type="text/html" id="action">
    <a href="?m=attachment&c=attachment&a=remote_edit&id={{d.id}}&menuid=<?php echo $_GET['menuid'];?>&pc_hash=<?php echo $_GET['pc_hash'];?>" class="layui-btn layui-btn-xs"><i class="fa fa-edit"></i> <?php echo L('edit');?></a>
