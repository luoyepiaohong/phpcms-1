...
class setting extends admin {
	...
	public function save() {
		...
		$setting['sysadmincode'] = intval($_POST['setting']['sysadmincode']);
		$setting['maxloginfailedtimes'] = intval($_POST['setting']['maxloginfailedtimes']);
		$setting['sysadminlogintimes'] = intval($_POST['setting']['sysadminlogintimes']);
		...
		if($_POST['setconfig']['auth_key']) {
			$setconfig = pc_base::load_config('system');
			$_POST['setconfig']['auth_key'] = dr_safe_filename($_POST['setconfig']['auth_key'] == '************' ? $setconfig['auth_key'] : $_POST['setconfig']['auth_key']);
		}
