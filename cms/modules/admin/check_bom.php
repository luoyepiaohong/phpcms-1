        ...
        if ($data) {
            ...
            foreach ($data as $filename) {
                ...
                if (ord ( $charset [1] ) == 239 && ord ( $charset [2] ) == 187 && ord ( $charset [3] ) == 191) {
                    ...
                    $class = ' p_error';
                } elseif (strpos($filename, PC_PATH.'plugin') !== false && strpos($contents, '$_POST[')) {
                ...
                } elseif (strpos($filename, PC_PATH.'plugin') !== false && strpos($contents, '$_GET[')) {
                ...
                $html.= '<p class="'.$class.'"><label class="rleft">'.$this->safe_replace_path($filename).'</label><label class="rright">'.$ok.'</label></p>';
                if ($class) {
