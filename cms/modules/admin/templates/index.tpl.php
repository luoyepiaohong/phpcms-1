            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" layuimini-content-href="?m=admin&c=admin_manage&a=public_edit_info&pc_hash=<?php echo $_SESSION['pc_hash']?>" data-title="基本资料" data-icon="fa fa-gears">基本资料<span class="layui-badge-dot"></span></a>
                        </dd>
                        <dd>
                            <a href="javascript:;" layuimini-content-href="?m=admin&c=admin_manage&a=public_edit_pwd&pc_hash=<?php echo $_SESSION['pc_hash']?>" data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
...
function site_select(siteid) {
    Dialog.confirm('你确定要切换到选中站点吗？', function() {
