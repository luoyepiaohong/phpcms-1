...
<div class="admin-main layui-anim layui-anim-upbit">
    ...
    <blockquote class="layui-elem-quote">
        <a href="?m=admin&c=menu&a=add&menuid=<?php echo $_GET['menuid'];?>" class="layui-btn layui-btn-sm">
...
<script type="text/html" id="action">
    <a href="?m=admin&c=menu&a=add&parentid={{d.id}}&menuid=<?php echo $_GET['menuid'];?>&pc_hash=<?php echo $_GET['pc_hash'];?>" class="layui-btn layui-btn-xs"><i class="fa fa-plus"></i> <?php echo L('add_submenu');?></a>
    <a href="?m=admin&c=menu&a=edit&id={{d.id}}&menuid=<?php echo $_GET['menuid'];?>&pc_hash=<?php echo $_GET['pc_hash'];?>" class="layui-btn layui-btn-xs"><i class="fa fa-edit"></i> <?php echo L('modify');?></a>
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del"><i class="fa fa-trash-o"></i> <?php echo L('delete');?></a>
</script>
<script type="text/html" id="topBtn">
   <a href="?m=admin&c=menu&a=add&menuid=<?php echo $_GET['menuid'];?>&pc_hash=<?php echo $_GET['pc_hash'];?>" class="layui-btn layui-btn-sm"><?php echo L('add_menu');?></a>
</script>
<script>
    ...
    layui.config({
        ...
        ptable=treeGrid.render({
            ...
            ,cols: [[
                ...
                {field: 'manage',title: '<?php echo L('operations_manage');?>',width: 240,align: 'center', toolbar: '#action', fixed: 'right'}
            ]]
            ,page:false
        });
