                            ...
                            <div class="layui-card-body">
                                ...
                                <div class="welcome-module">
                                    <div class="layui-row layui-col-space10">
                                        ...
                                        <p><?php echo L('亲爱的：')?><span style="color:#ff0000;"><?php echo $admin_username?></span><span id="main_hello"></span></p>
            ...
            <div class="layui-col-md4">
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layui-text layadmin-text">
                        ...
                        <p><?php echo L('main_product_qq')?><?php echo $qq;?></p>
                        <p><?php echo L('main_product_tel')?><?php echo $tel;?></p>
                        <p><?php echo L('main_support')?><?php echo $designer;?><?php echo $programmer;?></p>
                        <p>技术交流QQ群（551419699）：<a target="_blank" href="https://jq.qq.com/?_wv=1027&k=isxNpmNK"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="layuimini" title="layuimini"></a>（加群请备注来源：如gitee官网等）</p>
