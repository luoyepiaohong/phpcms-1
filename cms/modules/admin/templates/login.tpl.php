...
<div class="container login">
    <form class="layui-form layui-form-pane" action="?m=admin&c=index&a=login&dosubmit=1" method="post" id="myform" name="myform" onsubmit="return login()">
...
function login() {
    ...
    $.ajax({
        type: 'post',
        url: '?m=admin&c=index&a=login&dosubmit=1',
