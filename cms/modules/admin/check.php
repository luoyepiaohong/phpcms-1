...
class check extends admin {
    ...
    public function public_do_index() {
        ...
        \'autoconnect\' => '.$my['autoconnect'].'
                ...
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'site_field_manage\', 64, \'content\', \'sitemodel_field\', \'init\', \'&modelid=0\', \'fa fa-puzzle-piece\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'category_field_manage', 'parentid' => 43, 'm' => 'content', 'c' => 'sitemodel_field', 'a' => 'init', 'data' => '&modelid=-1'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'category_field_manage\', 43, \'content\', \'sitemodel_field\', \'init\', \'&modelid=-1\', \'fa fa-cog\', 7, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'page_field_manage', 'parentid' => 43, 'm' => 'content', 'c' => 'sitemodel_field', 'a' => 'init', 'data' => '&modelid=-2'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'page_field_manage\', 43, \'content\', \'sitemodel_field\', \'init\', \'&modelid=-2\', \'fa fa-list-alt\', 8, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'recycle', 'parentid' => 822, 'm' => 'content', 'c' => 'content', 'a' => 'recycle_init'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'recycle\', 822, \'content\', \'content\', \'recycle_init\', \'\', \'fa fa-list\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'restore', 'parentid' => 822, 'm' => 'content', 'c' => 'content', 'a' => 'recycle'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'restore\', 822, \'content\', \'content\', \'recycle\', \'\', \'fa fa-users\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'update', 'parentid' => 822, 'm' => 'content', 'c' => 'content', 'a' => 'update'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'update\', 822, \'content\', \'content\', \'update\', \'\', \'fa fa-user\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'content_all', 'parentid' => 822, 'm' => 'content', 'c' => 'content', 'a' => 'initall'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'content_all\', 822, \'content\', \'content\', \'initall\', \'\', \'fa fa-sort-numeric-asc\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'create_all', 'parentid' => 873, 'm' => 'content', 'c' => 'create_all_html', 'a' => 'all_update'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'create_all\', 873, \'content\', \'create_all_html\', \'all_update\', \'\', \'fa fa-user\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'public_error', 'parentid' => 977, 'm' => 'admin', 'c' => 'index', 'a' => 'public_error'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'public_error\', 977, \'admin\', \'index\', \'public_error\', \'\', \'fa fa-list-alt\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                ...
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'remote_delete\', '.$parentid.', \'attachment\', \'attachment\', \'remote_delete\', \'\', \'fa fa-trash\', 0, \'0\', 1, 1, 1, 1, 1);');
                }
...
//附件相关配置
\'upload_path\' => '.str_replace(CMS_PATH, 'CMS_PATH.\'' ,pc_base::load_config('system','upload_path')).'\',
\'upload_url\' => \''.pc_base::load_config('system','upload_url').'\', //附件路径
...
\'sys_attachment_attach\' => '.(pc_base::load_config('system','sys_attachment_attach') ? pc_base::load_config('system','sys_attachment_attach') : 0).', //附件存储策略
...
\'timezone\' => \''.pc_base::load_config('system','timezone').'\', //网站时区（只对php 5.1以上版本有效），Etc/GMT-8 实际表示的是 GMT+8
...
\'admin_login_path\' => \''.pc_base::load_config('system','admin_login_path').'\',//自定义的后台登录地址';
                ...
                if (!strstr($system, 'IN_CMS') || strstr($system, 'admin_url') || strstr($system, 'safe_card') || strstr($system, 'phpsso') || strstr($system, 'phpsso_appid') || strstr($system, 'phpsso_api_url') || strstr($system, 'phpsso_auth_key') || strstr($system, 'phpsso_version') || !strstr($system, 'attachment_file') || !strstr($system, 'sys_attachment_attach') || !strstr($system, 'sys_attachment_path') || !strstr($system, 'sys_attachment_save_type') || !strstr($system, 'sys_attachment_save_dir') || !strstr($system, 'sys_attachment_url') || !strstr($system, 'sys_avatar_path') || !strstr($system, 'sys_avatar_url') || !strstr($system, 'sys_thumb_path') || !strstr($system, 'sys_thumb_url') || !strstr($system, 'mobile_js_path') || !strstr($system, 'mobile_css_path') || !strstr($system, 'mobile_img_path') || !strstr($system, 'mobile_path') || !strstr($system, 'editor') || !strstr($system, 'mobile_root') || !strstr($system, 'keywordapi') || !strstr($system, 'baidu_aid') || !strstr($system, 'baidu_skey') || !strstr($system, 'baidu_arcretkey') || !strstr($system, 'baidu_qcnum') || !strstr($system, 'xunfei_aid') || !strstr($system, 'xunfei_skey') || !strstr($system, 'admin_login_path')) {
