	function editor($field, $value) {
		...
		if($enablesaveimage) {
			$value = $this->download->download($value, $watermark, $attachment, $image_reduce, $_POST['info']['catid']);
		}
		if(intval($local_img)) {
			...
			$value = $this->download->upload_local($value, $local_watermark, $local_attachment, $local_image_reduce, $_POST['info']['catid']);
		}
