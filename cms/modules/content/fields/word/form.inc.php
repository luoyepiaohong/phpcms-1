	function word($field, $value, $fieldinfo) {
		...
		if(!defined('LAYUI_INIT')) {
			$str .= '<link rel="stylesheet" href="'.JS_PATH.'layui/css/layui.css" media="all" />';
			...
			$str .= '		url: \''.WEB_PATH.'api.php?op=get_word&module=content&catid='.intval($_GET['catid']).'&watermark='.$watermark.'&attachment='.$attachment.'&image_reduce='.$image_reduce.'\',';
			$str .= '		exts: \'docx\',';
