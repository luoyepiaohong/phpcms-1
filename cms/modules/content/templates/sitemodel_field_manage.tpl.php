...
<a href="javascript:;" onclick="javascript:openwinx('?m=content&c=sitemodel_field&a=public_priview&modelid=<?php echo $modelid?>&menuid=<?php echo $_GET['menuid']?>&pc_hash=<?php echo $_SESSION['pc_hash'];?>','')"><em><?php echo L('priview_modelfield');?></em></a>
<?php }?>
</div></div>
<div class="pad-lr-10">
