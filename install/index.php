...
switch($step)
{
	...
	case 'installmodule': //执行SQL
		...
		if($module == 'admin') {
			...
			if(file_exists(CMS_PATH."install/main/".$dbfile)) {
				...
				if ($adminpath) {
					//设置后台登录地址
					if(CHARSET=='gbk') $adminpath = iconv('UTF-8','GBK',$adminpath);
					...
					if(pc_base::load_config('system','admin_login_path')) {
						...
						$adminclass = file_get_contents(CMS_PATH.'cms/modules/admin/classes/admin.class.php');
						$adminclass = str_replace("array('".pc_base::load_config('system','admin_login_path')."', 'public_card', 'fclient')","array('".$adminpath."', 'public_card', 'fclient')",$adminclass);
						$adminclass = str_replace("array('".pc_base::load_config('system','admin_login_path')."', 'init', 'public_card', 'fclient')","array('".$adminpath."', 'init', 'public_card', 'fclient')",$adminclass);
						$adminclass = str_replace("array('".pc_base::load_config('system','admin_login_path')."')","array('".$adminpath."')",$adminclass);
						$adminclass = str_replace("ROUTE_A == '".pc_base::load_config('system','admin_login_path')."'","ROUTE_A == '".$adminpath."'",$adminclass);
						$adminclass = str_replace('?m=admin&c=index&a='.pc_base::load_config('system','admin_login_path'),'?m=admin&c=index&a='.$adminpath,$adminclass);
						file_put_contents(CMS_PATH."cms/modules/admin/classes/admin.class.php",$adminclass);
						$login = file_get_contents(CMS_PATH.'cms/modules/admin/templates/login.tpl.php');
						$login = str_replace("m=admin&c=index&a=".pc_base::load_config('system','admin_login_path'),"m=admin&c=index&a=".$adminpath,$login);
						file_put_contents(CMS_PATH."cms/modules/admin/templates/login.tpl.php",$login);
						$header = file_get_contents(CMS_PATH.'cms/modules/admin/templates/header.tpl.php');
						$header = str_replace("m=admin&c=index&a=".pc_base::load_config('system','admin_login_path'),"m=admin&c=index&a=".$adminpath,$header);
						$header = file_put_contents(CMS_PATH."cms/modules/admin/templates/header.tpl.php",$header);
						$paramclass = file_get_contents(CMS_PATH.'cms/libs/classes/param.class.php');
						$paramclass = str_replace("$a = '".pc_base::load_config('system','admin_login_path')."'","$a = '".$adminpath."'",$paramclass);
						$paramclass = file_put_contents(CMS_PATH."cms/libs/classes/param.class.php",$paramclass);
					} else {
						//建立自定义后台登录目录
						dir_create(CMS_PATH.$adminpath);
						...
						file_put_contents(CMS_PATH."cms/modules/admin/index.php",$index);
						$adminclass = file_get_contents(CMS_PATH.'cms/modules/admin/classes/admin.class.php');
						$adminclass = str_replace("array('login', 'public_card', 'fclient')","array('".$adminpath."', 'public_card', 'fclient')",$adminclass);
						$adminclass = str_replace("array('login', 'init', 'public_card', 'fclient')","array('".$adminpath."', 'init', 'public_card', 'fclient')",$adminclass);
						$adminclass = str_replace("array('login')","array('".$adminpath."')",$adminclass);
						$adminclass = str_replace("ROUTE_A == 'login'","ROUTE_A == '".$adminpath."'",$adminclass);
						$adminclass = str_replace('?m=admin&c=index&a=login','?m=admin&c=index&a='.$adminpath,$adminclass);
						file_put_contents(CMS_PATH."cms/modules/admin/classes/admin.class.php",$adminclass);
						$login = file_get_contents(CMS_PATH.'cms/modules/admin/templates/login.tpl.php');
						$login = str_replace("m=admin&c=index&a=login","m=admin&c=index&a=".$adminpath,$login);
						file_put_contents(CMS_PATH."cms/modules/admin/templates/login.tpl.php",$login);
						$header = file_get_contents(CMS_PATH.'cms/modules/admin/templates/header.tpl.php');
						$header = str_replace("m=admin&c=index&a=login","m=admin&c=index&a=".$adminpath,$header);
						$header = file_put_contents(CMS_PATH."cms/modules/admin/templates/header.tpl.php",$header);
						$paramclass = file_get_contents(CMS_PATH.'cms/libs/classes/param.class.php');
						$paramclass = str_replace("$a = 'login'","$a = '".$adminpath."'",$paramclass);
						$paramclass = file_put_contents(CMS_PATH."cms/libs/classes/param.class.php",$paramclass);
					}
	...
	case 'dbtest':
		extract($_GET);
		if(CHARSET=='gbk') $adminpath = iconv('UTF-8','GBK',$adminpath);
		$noname_arr = array('admin','api','caches','cms','html','mobile','statics','uploadfile');
