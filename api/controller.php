...
$CONFIG = array (
    ...
    'imagePathFormat'=>$site_setting['filename'], /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    'scrawlPathFormat'=>$site_setting['filename'], /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    'snapscreenPathFormat'=>$site_setting['filename'], /* 上传保存路径,可以自定义保存路径和文件名格式 */

    /* 抓取远程图片配置 */
    'catcherLocalDomain'=>array('127.0.0.1', 'localhost', 'img.baidu.com'),
    'catcherActionName'=>'catchimage', /* 执行抓取远程图片的action名称 */
    'catcherFieldName'=>'source', /* 提交的图片列表表单名称 */
    'catcherPathFormat'=>$site_setting['filename'], /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    'videoPathFormat'=>$site_setting['filename'], /* 上传保存路径,可以自定义保存路径和文件名格式 */
    ...
    "filePathFormat"=>$site_setting['filename'], /* 上传保存路径,可以自定义保存路径和文件名格式 */
